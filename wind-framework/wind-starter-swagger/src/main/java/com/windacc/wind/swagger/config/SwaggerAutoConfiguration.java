package com.windacc.wind.swagger.config;

import com.windacc.wind.swagger.properties.SwaggerProperties;
...
public class SwaggerAutoConfiguration implements BeanFactoryAware {
    ...
    public List<Docket> createRestApi(SwaggerProperties swaggerProperties) {
        ...
        for (String groupName : swaggerProperties.getDocket().keySet()) {
            ...
            Predicate<String> basePathPredicate = basePath.stream().reduce(x->false, Predicate::or);
            ...
            Predicate<String> excludePathPredicate = excludePath.stream().reduce(x->false, Predicate::or);
            ...
            Docket docket = new Docket(DocumentationType.SWAGGER_2)
                    ...
                    .paths(basePathPredicate.and(excludePathPredicate.negate()))
                    .build()
