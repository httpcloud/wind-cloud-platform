package com.fedorxe.wind.redis.config;

import com.fedorxe.wind.tool.utils.JsonUtil;
...
public class RedisService {
     ...
     * @return the string
     */
    public <T> T getEntity(final String key,  Class<T> clazz) {
        Object object = redisTemplate.opsForValue().get(key);
        return JsonUtil.convertValue(object, clazz);
    }
